...
export default function Tooltip({ text, children, position = 'top', className = '' }: TooltipProps) {
  ...
  return (
    <div className={`relative group/tip inline-flex ${className}`}>
      ...
      >
        <div className="bg-gray-800 border border-white/10 text-white text-xs rounded-lg px-2.5 py-1.5 w-max max-w-[220px] text-left leading-snug shadow-lg whitespace-normal">
          {text}
        </div>
