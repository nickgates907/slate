...
export default function PlaybackModal({ recording, saveFolder, onClose }: PlaybackModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80">
      <div className="bg-gray-900 rounded-2xl overflow-hidden shadow-2xl flex flex-col"
        ...
        {/* Save status */}
        <div className="px-5 py-3 flex items-center gap-3 border-t border-gray-800">
          {saveState === 'saving' && (
            <>
        ...
        <div className="px-5 pb-4 flex items-center gap-3">
          {mp4State === 'idle' && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-brand-red disabled:opacity-40 hover:bg-red-500 text-white text-xs font-semibold rounded-lg transition-colors"
            >
